...
5 phases: Foundation (Jul–Aug 2026) → Full Days + ITT/GMCS (Sep–Oct) → Heavy Subjects (Nov–Dec) → Customs + IBS + First Revision (Jan 2027) → 3-Month Revision Blitz (Feb–Apr 2027)
