...
Source field to log where you watched (ICAI, Bhavik, Yogesh, etc.)
...
Confidence rating: 1–5 dot scale (colour-coded red → green)

Last revised date + revision count

Overdue alerts (>14 days since last revision)

"Revise Soon" tags (7–14 days)

Lecture completion gate warning (encourages finishing lectures before revision)

FR Revision — Special Mode  

When FR is selected in Revision World:

52 chapters (Ind AS standard wise), names only — clean and fast

Status + Confidence + Last Revised date + Mark ✓ button

Important Questions (IQ) modal per chapter — add question numbers or descriptions (e.g. "Q5 Nov 24", "Lease Modification 
Q"), tick them off as you practice. Shows `done/total` count on the chapter row.
...
Tag sessions by subject and chapter
...
Countdown to exam date (days remaining)

Overall lecture % and revision % progress rings

Study streak tracker

Weekly target vs actual hours
...
5 phases: Foundation (Jul–Aug 2026) → Full Days + ITT/GMCS (Sep–Oct) → Heavy Subjects (Nov–Dec) → Customs + IBS + First 
Revision (Jan 2027) → 3-Month Revision Blitz (Feb–Apr 2027)
Week-by-week subject breakdown with daily hour targets (~1,400 hours total)

Accounts for articleship end, Advanced ITT, GMCS disruptions

All other attempts get a customisable plan builder:

Enter your study start date and exam date

Set weekday and weekend study hours

Auto-generates a 4-phase plan (Learning 40% → Practice 25% → Revision 25% → Final Push 10%) scaled to your exact timeline
...
Add amendments with subject, act, section, and description
...
Add formulae with LaTeX or plain text
...
Add doubts with subject and description
...
Log answers with question reference, subject, marks, and time taken
...
Hours logged by subject (bar chart)
...
Add mock tests with subject, date, marks scored, and total marks
...
Sync your data across devices using a GitHub Gist as a free backend.
